...
Statement st;
ResultSet rs;
	JLabel l1=new JLabel("CSE DEPARTMENT ISSUES ");
...
cb.addItem("No");
	...
	public void actionPerformed(ActionEvent arg)
	{
		...
		{		
		     try
		     {
		    	 st.executeUpdate("insert into cse values(' "+f2.getText()+" ' ,' "+c1.getSelectedItem()+" ',  ' "+cb.getSelectedItem()+" ' ,' "+a1.getText()+" ',' "+f1.getText()+" ' )" );
