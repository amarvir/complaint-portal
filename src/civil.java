...
import javax.swing.*;
public class civil extends JFrame implements ActionListener
{	Connection con;
Statement st;
ResultSet rs;
	JLabel l1=new JLabel("CIVIL DEPARTMENT ISSUES ");
...
cb.addItem("No");
	...
	public void actionPerformed(ActionEvent arg)
	{
		...
		{		
		     try
		     {
		    	 st.executeUpdate("insert into civil values(' "+f2.getText()+" ' ,' "+c1.getSelectedItem()+" ',  ' "+cb.getSelectedItem()+" ' ,' "+a1.getText()+" ',' "+f1.getText()+" ' )" );
