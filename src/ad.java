...
JLabel l7=new JLabel("REGESTERATION OF NEW STUDENTS ");
...
public ad()
{
	...
	this.setSize(500,500);add(background);background.add(l7);
	background.add(l1);background.add(l3);background.add(f1);background.add(f3);background.add(c1);background.add(b2);background.add(l4);background.add(l4);background.add(f4);background.add(f5);background.add(l5);background.add(l6);background.add(f6);
	this.setVisible(true);
	l1.setBounds(20,150,100,40);
	c1.addItem("cse");
	c1.addItem("mech");
	c1.addItem("civil");
	c1.addItem("elect");
